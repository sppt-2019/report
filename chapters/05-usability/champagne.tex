...
\begin{table}[H]
	...
	\begin{tabular}{| l | l | l |}\hline
		& \textbf{F\#} & \textbf{C\#} \rowEnd
	 	Abstract Gradient &  & \mn \rowEnd
		Closeness of Mapping & \mn\mn &  \rowEnd
		Consistency & \mn\mn\mns\mns\mns & \mn\mn \rowEnd
		Diffuseness/Terseness & \mn\mn & \mn \rowEnd
		Error-proneness & \mn\mns\mns\mns & \mn \rowEnd
		...
		Role-expressiveness & \mn\mn\mns & \mn \rowEnd
