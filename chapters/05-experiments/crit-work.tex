...
In this section we present results from an experiment that estimates how much work needs to be done in an async workflow or task to outweigh the performance penalty. This is the real-world equivalent of the program's span (see \secref{work-span} and \secref{implicit-para}). We also implement a matrix summation benchmark to determine how different parallelisation strategies handle matrices of increasing sizes.
