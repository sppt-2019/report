...
}{Cognitive dimensions findings (results from participant 5 has been omitted).}{cog-dim-findings}
...
\input{chapters/04-usability/dimensions/error-proneness.tex}
\input{chapters/04-usability/dimensions/premature-commitment.tex}
...
\input{chapters/04-usability/dimensions/visibility-and-juxtaposability.tex}

%\subsubsection{Remaining Dimensions}
%The error-proneness dimension has been marked for all participants, but we have not included it here, as many of the situations was a result of the participants getting used to a new language. 