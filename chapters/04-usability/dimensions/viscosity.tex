...
\begin{itemize}
    ...
    \item Change the signature of the \ttt{TransferState}-method in \lstref{csharp:viscous:transfer} to accept an additional list and add an additional \ttt{else if} for the third list.
