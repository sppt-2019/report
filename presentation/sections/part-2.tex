...
\begin{tikzpicture}
	...
	\tikzstyle{system}=[rectangle, draw=black, rounded corners, rectangle split, , rectangle split parts=2,
        text centered, anchor=north, text=black, text width=3cm]
	...
	\def \y {-2.5}
	    ...
	    \node (obj1) [class] at (0,0){
	            \textbf{Object}
	            \nodepart{second}\m{speed:float}\newline
							\m{timer:float}\newline
							\nodepart{third}\m{OnCollision()}
	    };

			\node (sys1) [system] at (0,\y){
	            \textbf{System}
